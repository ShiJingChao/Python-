...
# 面试题sort(reverse关键字)和reverse方法的区别


# l = [1, 2, 8, 4]
# # l.sort(reverse=True)    # 运行结果：[8, 4, 2, 1]
# l.reverse()                #运行结果：[4, 8, 2, 1]   硬性反转 不会排序
# print(l)
#
# a = {"a","b","a"}
# print(a)
...
#
# mkdir("D:\music")
# wenjian = ["music", "dangce", "songs", "news"]
# path = "D:"
# for i in wenjian:
#     mkdir(i)    # 遍历列表创建文件夹
#     chdir(i)    #
#     mkdir(time.strftime("%Y-%m-%d".format()))
# import time
#
# a = ["music", "dangce", "songs", "news"]
# import os
# path = 'D:'
# for i in a:
#     b = os.path.exists(path + i)
#     if b:
#         print('不需要')
#     else:
#         os.mkdir(path + i)
